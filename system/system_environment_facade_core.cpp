...
#include "objrepr_bus_core.h"
#include "config_reader.h"
#include "system_environment_facade_core.h"

using namespace std;
using namespace common_types;

static constexpr const char * PRINT_HEADER = "SystemEnvironmentCore:";

SystemEnvironmentFacadeCore::SystemEnvironmentFacadeCore()
{
...
bool SystemEnvironmentFacadeCore::init( const SInitSettings & _settings ){
