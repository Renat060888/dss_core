...
boost::signals2::signal<void()> DistributedSimulationSystem::m_unixInterruptSignal;
static constexpr const char * PRINT_HEADER = "DistributedSimulationSystem:";

DistributedSimulationSystem::DistributedSimulationSystem()
    ...
    , m_shutdownCalled(false)
{
    ...
    m_commandServices.signalShutdownServer = std::bind( & DistributedSimulationSystem::shutdown, this );

    m_communicateGateway = new CommunicationGatewayFacadeDSS();
}
...
bool DistributedSimulationSystem::init( const SInitSettings & _settings ){
...
void DistributedSimulationSystem::launch(){
...
void DistributedSimulationSystem::shutdown(){
...
void DistributedSimulationSystem::shutdownByUnixInterruptSignal(){

    m_shutdownCalled.store( true );
}

void DistributedSimulationSystem::callbackUnixInterruptSignal(){
